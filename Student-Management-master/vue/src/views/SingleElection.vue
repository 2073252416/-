                ...
                <form @submit="TianJia" action="#" class="formbox">
                    <ul class="formlist">
                        <li>
                            ...
                            <textarea class="tigan" type="text" style="width:70.4%;height:118px;margin-top:5px;" v-model="title"></textarea>
                        </li>
                        <li>
                            ...
                            <p class="A">(A)</p>
                            <input class="AA" type="text" style="width:70.4%;height:60px;margin-top:5px;" v-model="one" />
                            <p class="B">(B)</p>
                            <input class="BB" type="text" style="width:70.4%;height:60px;margin-top:5px;" v-model="two" />
                            <p class="C">(C)</p>
                            <input class="CC" type="text" style="width:70.4%;height:60px;margin-top:5px;" v-model="three" />
                            <p class="D">(D)</p>
                            <input class="DD" type="text" style="width:70.4%;height:60px;margin-top:5px;" v-model="four" />
                        </li>
                        <li>
                            <h3 style="font-size:15px;margin-top:25px;font-weight:500">试题答案</h3>
                            <input type="checkbox" value="a"   checked style="margin-top:17px;" v-model="a" />A
                            <input type="checkbox" value="b"   checked style="margin-left:3.6%;" v-model="b" />B
                            <input type="checkbox" value="c"   checked style="margin-left:3.6%;" v-model="c" />C
                            <input type="checkbox" value="d"   checked style="margin-left:3.6%;" v-model="d" />D
                        </li>
                        <li>
...
export default {
  ...
  data: function() {
    ...
    methods:{
        ...
        TianJia() {
        axios.post("http://127.0.0.1:7001/mspost",{
          title:this.title,
          one:this.one,
          two:this.two,
          three:this.three,
