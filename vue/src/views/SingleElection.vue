                ...
                <form @submit="TianJia" action="#" class="formbox">
                    <ul class="formlist">
                        ...
                        <li>
                            ...
                            <p class="A">(A)</p>
                            <input type="text" style="width:70.4%;height:60px;margin-top:5px;" v-model="one" />
                            <p class="B">(B)</p>
                            <input type="text" style="width:70.4%;height:60px;margin-top:5px;" v-model="two" />
                            <p class="C">(C)</p>
                            <input type="text" style="width:70.4%;height:60px;margin-top:5px;" v-model="three" />
                            <p class="D">(D)</p>
                            <input type="text" style="width:70.4%;height:60px;margin-top:5px;" v-model="four" />
                        </li>
                        <li>
